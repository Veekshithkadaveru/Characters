...
fun CharactersBottomNav(navController: NavHostController) {
    BottomNavigation(elevation = 5.dp) {
        ...
        val iconLibrary = painterResource(id = com.example.characters.R.drawable.library)
        val iconCollection = painterResource(id = com.example.characters.R.drawable.collection)
